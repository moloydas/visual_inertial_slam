...
if __name__ == '__main__':
    ...
    sub_features = disparity_filter_measurements(features, n=700)
    ...
    for i in tqdm(range(dt.shape[0])):
        ...
        if i % 200 == 0:
            visualize_trajectory_landmark_2d(wTi, m, path_name="visual SLAM",show_ori=True, save_path="results_across_time/{}.png".format(i), show=False, max_num=i)
